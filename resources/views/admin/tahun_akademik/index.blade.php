                                ...
                                @foreach ($tahuns as $tahun)
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex items-center space-x-4 text-sm">
                                            ...
                                            <form action="{{ route('hapus_tahun_akademik', ['id' => $tahun->id_ta]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                  ...
                  <!-- Pagination -->
                    <div
                        ...
                        <span class="flex items-center  col-span-3">
                            Showing {{ $tahuns->firstItem() }}-{{ $tahuns->lastItem() }} of {{ $tahuns->total() }}
                        </span>
                        <div
                            class="flex px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
            ...
            <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
                ...
                <div class="mt-4 mb-6">
                    ...
                    <!-- Modal description -->
                    <form class="grid grid-cols-2" action="{{ route('tambah_tahun_akademik') }}" method="POST">
                        @csrf
