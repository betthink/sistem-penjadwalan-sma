              ...
              <ul class="mt-6">
                  ...
                  <li class="relative px-6 py-3">
                      ...
                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                          ...
                          <span class="ml-4 {{ $title === 'Master guru' ? 'dark:text-white' : '' }}">Master Guru</span>
                      </a>
                  </li>
                  <li class="relative px-6 py-3">
                      ...
                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                          ...
                          <span class="ml-4  {{ $title === 'Master kelas' ? 'dark:text-white' : '' }}">Master
                              kelas</span>
                      </a>
                  </li>
                  ...
                  <li class="relative px-6 py-3">
                      ...
                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                          ...
                          <span class="ml-4  {{ $title === 'Master mapel' ? 'dark:text-white' : '' }}">Master
                              Mapel</span>
                      </a>
                  </li>
                  <li class="relative px-6 py-3">
